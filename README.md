...
- **17-Dec-2025 (Wednesday)**  
  - Studied the history and key features of Java  
  - Solved elementary problems  
- **18-Dec-2025 (Thursday)**  
  - Continued with documentation work  
  - Practiced Level 1, 2, 3 Elementary Programming Problems
- **19-Dec-2025 (Friday)**  
  - Completed and submitted Level 1 and Level 2 problems on Control Flow 
...
- **25-Dec-2025 (Thursday)**
  - Solved Level 2 and Level 3 Practice Problems on Methods
  - Solved some EXTRA problems on String Functions
- **26-Dec-2025 (Friday)**
  - Solved Built-In Functions Practice Problems

##WEEK 3: OOPS Programming 
...
- **30-Dec-2025 (Tuesday)**
 - Studied about classes, objects, instance and class variables
